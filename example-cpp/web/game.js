(function () {
  ...
  function createShell(target) {
    ...
    title.textContent = "Booting example-cpp";
  ...
  function showFatal(shell, message, error) {
    ...
    shell.overlayTitle.textContent = "Failed to boot example-cpp";
  ...
  // Boot the host, instantiate the raw wasm module, then hand control to C++.
  async function main() {
    ...
    const imports = {
      // Keep the import surface narrow: C++ asks JS to draw, update host UI,
